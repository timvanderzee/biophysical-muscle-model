...
%         parms.J2 = 200;
    ...
    IG = get_initial_guess_old(tis, Cas, vis, parms.Lts, parms);
...
%     figure(100)
    [newparms, out] = fit_model_parameters_v2_old(optparms, w, Xdata, fparms, IG, bnds);
    ...
    oldparms = load(['parms_', filename, '_v3.mat'], 'newparms', 'optparms', 'out', 'bnds');
