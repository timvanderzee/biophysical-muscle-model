...
pCas = 6.6; %[4.5 6.1 6.2 6.3 6.4 6.6 9];
...
%             n0(parms.xi > 0 & parms.xi < 1) = 1e-3;
%             F0 = trapz(parms.xi, n0.*parms.xi);
            
            x0 = [n0'; parms.x0(4:end-1)'];
...
%                                 end
                                ...
                                if discretized_model
                                    ...
                                    F2 = nan(1, length(sol.x));
                                    for iiii = 1:length(sol.x)
                                        n = sol.y(1:end-3,iiii);
                                        xi = parms.xi + sol.y(end-2,iiii);
                                        F2(iiii) = trapz(xi, xi .* n') + trapz(xi, n');
                                    end
